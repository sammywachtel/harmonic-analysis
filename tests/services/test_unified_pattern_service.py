...
class TestUnifiedPatternServiceCompatibility:
    ...
    @pytest.mark.asyncio
    async def test_async_analysis_produces_valid_output(self, unified_service, test_progressions):
        ...
        for progression in test_progressions:
            ...
            print(f"✅ {progression['name']}: {result.primary.type}, confidence: {result.primary.confidence:.2f}")

    def test_sync_analysis_produces_valid_output(self, unified_service, test_progressions):
    ...
    def test_parameter_compatibility(self, unified_service):
        ...
        try:
            ...
            pytest.fail(f"UnifiedPatternService not compatible with legacy parameters: {e}")
